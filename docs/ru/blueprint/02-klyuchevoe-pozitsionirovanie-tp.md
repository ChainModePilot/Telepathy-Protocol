...
Когнитивное состояние Fay — это фундаментально структурированные данные — память представляет собой индексируемый граф знаний, представления — сериализуемые деревья состояний, а правила рассуждений — разделяемые логические движки. Когда два Fay устанавливают сессию TP, они могут в рамках авторизации Human Prime включить части своих когнитивных ресурсов в общее пространство:
