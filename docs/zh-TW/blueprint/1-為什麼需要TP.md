...
在 iFay 體系中，世界觀截然不同。每一個 Fay（無論是代表個人的 iFay，還是承擔社會公共職能的 coFay）都有明確的**宿主（Host）**。Fay 代表宿主行事，維護宿主的利益，保護宿主的隱私。

這意味著，當兩個 Fay 進行通訊時，本質上發生的並非兩個軟體服務之間的資料交換，而是**兩個宿主的代理人之間的交涉**——如同律師代表當事人談判，秘書代表老闆協調事務。
