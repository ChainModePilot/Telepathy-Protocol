...
| **Attribution d'identité** | Aucune (les outils n'ont pas de concept d'attribution) | Aucune (les Agents sont des nœuds de service autonomes) | Oui (chaque Fay agit au nom d'un Host) |
| **Protection de la vie privée** | Pas de mécanisme systématique (passage de paramètres en clair) | Pas de mécanisme systématique | Chiffrement de bout en bout + Divulgation sélective + Autorisation du Host |
