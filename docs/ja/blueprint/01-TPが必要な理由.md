...
iFay 体系では、世界観は全く異なる。すべての Fay（個人を代表する iFay であれ、社会的公共機能を担う coFay であれ）には明確な**Human Prime**が存在する。Fay は Human Prime を代表して行動し、Human Prime の利益を守り、Human Prime のプライバシーを保護する。

これは、二つの Fay が通信を行う際、本質的に起きているのは二つのソフトウェアサービス間のデータ交換ではなく、**二人の Human Prime の代理人間の交渉**であることを意味する——弁護士が当事者を代表して交渉し、秘書が上司を代表して事務を調整するように。
